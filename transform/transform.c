...
#line 48 "transform.y"
                               { printf("%s\n", yyvsp[-1]); }
#line 1159 "transform.c"
    break;

  case 5: /* expr: expr ADD expr  */
#line 67 "transform.y"
                                { yyval = strdup(yyvsp[-2]); strcat(yyval,yyvsp[0]); strcat(yyval,"+ "); }
#line 1165 "transform.c"
    break;

  case 6: /* expr: expr MINUS expr  */
#line 68 "transform.y"
                                { yyval = strdup(yyvsp[-2]); strcat(yyval,yyvsp[0]); strcat(yyval,"- "); }
#line 1171 "transform.c"
    break;

  case 7: /* expr: expr MUL expr  */
#line 69 "transform.y"
                                { yyval = strdup(yyvsp[-2]); strcat(yyval,yyvsp[0]); strcat(yyval,"* "); }
#line 1177 "transform.c"
    break;

  case 8: /* expr: expr DIV expr  */
#line 70 "transform.y"
                                { yyval = strdup(yyvsp[-2]); strcat(yyval,yyvsp[0]); strcat(yyval,"/ "); }
#line 1183 "transform.c"
    break;

  case 9: /* expr: LEFT_PAREN expr RIGHT_PAREN  */
#line 71 "transform.y"
                                            { yyval = strdup(yyvsp[-1]); }
#line 1189 "transform.c"
    break;

  case 10: /* expr: NUMBER  */
#line 72 "transform.y"
                                { yyval = strdup(yyvsp[0]); strcat(yyval," "); }
#line 1195 "transform.c"
    break;

  case 11: /* expr: MINUS expr  */
#line 73 "transform.y"
                                          { yyval = strdup("- "); strcat(yyval,yyvsp[0]); }
#line 1201 "transform.c"
    break;

  case 12: /* expr: ID  */
#line 74 "transform.y"
                          { yyval = strdup(yyvsp[0]); strcat(yyval," "); }
#line 1207 "transform.c"
    break;


#line 1211 "transform.c"

...
static const char *const yytname[] =
{
  ...
  "DIV", "UMINUS", "LEFT_PAR", "RIGHT_PAR", "ID", "NUMBER", "ASSIGN",
...
{
     -10,     0,   -10,    20,    20,    -9,   -10,   -10,    16,   -10,
      29,    20,    20,    20,    20,    20,   -10,   -10,    36,    -4,
      -4,   -10,   -10
};
...
{
       4,     0,     1,     0,     0,    13,    12,     3,     0,    11,
       0,     0,     0,     0,     0,     0,     2,    10,     7,     5,
       6,     8,     9
};
...
{
       2,    14,    15,    11,     3,     0,     9,    10,     4,     0,
       5,     6,     0,     7,    18,    19,    20,    21,    22,    12,
      13,    14,    15,     0,     3,     0,     0,     0,     4,    16,
       5,     6,    12,    13,    14,    15,     0,     0,    17,    12,
      13,    14,    15
};

static const yytype_int8 yycheck[] =
{
       0,     5,     6,    12,     4,    -1,     3,     4,     8,    -1,
      10,    11,    -1,    13,    11,    12,    13,    14,    15,     3,
       4,     5,     6,    -1,     4,    -1,    -1,    -1,     8,    13,
      10,    11,     3,     4,     5,     6,    -1,    -1,     9,     3,
       4,     5,     6
};
...
#line 56 "advanced.y"
                       { printf("%f\n", (yyvsp[-1].val)); }
#line 1177 "advanced.c"
    break;

  case 5: /* expr: expr ADD expr  */
#line 61 "advanced.y"
                     { (yyval.val) = (yyvsp[-2].val) + (yyvsp[0].val); }
#line 1183 "advanced.c"
    break;

  case 6: /* expr: expr MINUS expr  */
#line 62 "advanced.y"
                       { (yyval.val) = (yyvsp[-2].val) - (yyvsp[0].val); }
#line 1189 "advanced.c"
    break;

  case 7: /* expr: ID ASSIGN expr  */
#line 63 "advanced.y"
                      { (yyvsp[-2].sym)->value = (yyvsp[0].val); (yyval.val) = (yyvsp[-2].sym)->value; }
#line 1195 "advanced.c"
    break;

  case 8: /* expr: expr MUL expr  */
#line 64 "advanced.y"
                     { (yyval.val) = (yyvsp[-2].val) * (yyvsp[0].val); }
#line 1201 "advanced.c"
    break;

  case 9: /* expr: expr DIV expr  */
#line 65 "advanced.y"
                     { (yyval.val) = (yyvsp[-2].val) / (yyvsp[0].val); }
#line 1207 "advanced.c"
    break;

  case 10: /* expr: LEFT_PAR expr RIGHT_PAR  */
#line 66 "advanced.y"
                               { (yyval.val) = (yyvsp[-1].val); }
#line 1213 "advanced.c"
    break;

  case 11: /* expr: MINUS expr  */
#line 67 "advanced.y"
                               { (yyval.val) = -(yyvsp[0].val); }
#line 1219 "advanced.c"
    break;

  case 12: /* expr: NUMBER  */
#line 68 "advanced.y"
              { (yyval.val) = (yyvsp[0].val); }
#line 1225 "advanced.c"
    break;

  case 13: /* expr: ID  */
#line 69 "advanced.y"
          { (yyval.val) = (yyvsp[0].sym)->value; }
#line 1231 "advanced.c"
    break;


#line 1235 "advanced.c"
